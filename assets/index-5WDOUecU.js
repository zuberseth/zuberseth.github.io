var Ce=Object.defineProperty;var le=o=>{throw TypeError(o)};var Me=(o,e,t)=>e in o?Ce(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t;var k=(o,e,t)=>Me(o,typeof e!="symbol"?e+"":e,t),Pe=(o,e,t)=>e.has(o)||le("Cannot "+t);var ce=(o,e,t)=>e.has(o)?le("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(o):e.set(o,t);var q=(o,e,t)=>(Pe(o,e,"access private method"),t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function t(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(s){if(s.ep)return;s.ep=!0;const r=t(s);fetch(s.href,r)}})();class De{constructor(){this.routes={},this.currentRoute=null,window.addEventListener("hashchange",()=>this.handleRoute()),window.addEventListener("load",()=>this.handleRoute())}on(e,t){return this.routes[e]=t,this}navigate(e){window.location.hash=e}handleRoute(){const e=window.location.hash.slice(1)||"/",[t,...n]=e.split("/").filter(Boolean),s="/"+(t||"");this.updateNavLinks(s);let r=this.routes[s],i=n;if(!r){for(const[a,l]of Object.entries(this.routes))if(a.includes(":")){const u=a.split("/").filter(Boolean),d=[t,...n];if(u.length===d.length){let h=!0;i={};for(let c=0;c<u.length;c++)if(u[c].startsWith(":"))i[u[c].slice(1)]=d[c];else if(u[c]!==d[c]){h=!1;break}if(h){r=l;break}}}}r?(this.currentRoute=s,r(i)):this.show404()}updateNavLinks(e){document.querySelectorAll(".nav-link").forEach(t=>{const n=t.getAttribute("href").slice(1);n===e||e.startsWith(n)&&n!=="/"?t.classList.add("active"):t.classList.remove("active")})}show404(){const e=document.getElementById("main-content");e.innerHTML=`
        ...
        `}}function V(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}let L=V();function ke(o){L=o}const be=/[&<>"']/,Ue=new RegExp(be.source,"g"),ye=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,qe=new RegExp(ye.source,"g"),Oe={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},de=o=>Oe[o];function y(o,e){if(e){if(be.test(o))return o.replace(Ue,de)}else if(ye.test(o))return o.replace(qe,de);return o}const je=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig;function Ne(o){return o.replace(je,(e,t)=>(t=t.toLowerCase(),t==="colon"?":":t.charAt(0)==="#"?t.charAt(1)==="x"?String.fromCharCode(parseInt(t.substring(2),16)):String.fromCharCode(+t.substring(1)):""))}const He=/(^|[^\[])\^/g;function g(o,e){let t=typeof o=="string"?o:o.source;e=e||"";const n={replace:(s,r)=>{let i=typeof r=="string"?r:r.source;return i=i.replace(He,"$1"),t=t.replace(s,i),n},getRegex:()=>new RegExp(t,e)};return n}function ue(o){try{o=encodeURI(o).replace(/%25/g,"%")}catch{return null}return o}const C={exec:()=>null};function pe(o,e){const t=o.replace(/\|/g,(r,i,a)=>{let l=!1,u=i;for(;--u>=0&&a[u]==="\\";)l=!l;return l?"|":" |"}),n=t.split(/ \|/);let s=0;if(n[0].trim()||n.shift(),n.length>0&&!n[n.length-1].trim()&&n.pop(),e)if(n.length>e)n.splice(e);else for(;n.length<e;)n.push("");for(;s<n.length;s++)n[s]=n[s].trim().replace(/\\\|/g,"|");return n}function O(o,e,t){const n=o.length;if(n===0)return"";let s=0;for(;s<n&&o.charAt(n-s-1)===e;)s++;return o.slice(0,n-s)}function We(o,e){if(o.indexOf(e[1])===-1)return-1;let t=0;for(let n=0;n<o.length;n++)if(o[n]==="\\")n++;else if(o[n]===e[0])t++;else if(o[n]===e[1]&&(t--,t<0))return n;return-1}function he(o,e,t,n){const s=e.href,r=e.title?y(e.title):null,i=o[1].replace(/\\([\[\]])/g,"$1");if(o[0].charAt(0)!=="!"){n.state.inLink=!0;const a={type:"link",raw:t,href:s,title:r,text:i,tokens:n.inlineTokens(i)};return n.state.inLink=!1,a}return{type:"image",raw:t,href:s,title:r,text:y(i)}}function Ze(o,e){const t=o.match(/^(\s+)(?:```)/);if(t===null)return e;const n=t[1];return e.split(`
`).map(s=>{const r=s.match(/^\s+/);if(r===null)return s;const[i]=r;return i.length>=n.length?s.slice(n.length):s}).join(`
`)}class N{constructor(e){k(this,"options");k(this,"rules");k(this,"lexer");this.options=e||L}space(e){const t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(e){const t=this.rules.block.code.exec(e);if(t){const n=t[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?n:O(n,`
...
`}strong(e){return`<strong>${e}</strong>`}em(e){return`<em>${e}</em>`}codespan(e){return`<code>${e}</code>`}br(){return"<br>"}del(e){return`<del>${e}</del>`}link(e,t,n){const s=ue(e);if(s===null)return n;e=s;let r='<a href="'+e+'"';return t&&(r+=' title="'+t+'"'),r+=">"+n+"</a>",r}image(e,t,n){const s=ue(e);if(s===null)return n;e=s;let r=`<img src="${e}" alt="${n}"`;return t&&(r+=` title="${t}"`),r+=">",r}text(e){return e}}class se{strong(e){return e}em(e){return e}codespan(e){return e}del(e){return e}html(e){return e}text(e){return e}link(e,t,n){return""+n}image(e,t,n){return""+n}br(){return""}}class ${constructor(e){k(this,"options");k(this,"renderer");k(this,"textRenderer");this.options=e||L,this.options.renderer=this.options.renderer||new W,this.renderer=this.options.renderer,this.renderer.options=this.options,this.textRenderer=new se}static parse(e,t){return new $(t).parse(e)}static parseInline(e,t){return new $(t).parseInline(e)}parse(e,t=!0){let n="";for(let s=0;s<e.length;s++){const r=e[s];if(this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[r.type]){const i=r,a=this.options.extensions.renderers[i.type].call({parser:this},i);if(a!==!1||!["space","hr","heading","code","table","blockquote","list","html","paragraph","text"].includes(i.type)){n+=a||"";continue}}switch(r.type){case"space":continue;case"hr":{n+=this.renderer.hr();continue}case"heading":{const i=r;n+=this.renderer.heading(this.parseInline(i.tokens),i.depth,Ne(this.parseInline(i.tokens,this.textRenderer)));continue}case"code":{const i=r;n+=this.renderer.code(i.text,i.lang,!!i.escaped);continue}case"table":{const i=r;let a="",l="";for(let d=0;d<i.header.length;d++)l+=this.renderer.tablecell(this.parseInline(i.header[d].tokens),{header:!0,align:i.align[d]});a+=this.renderer.tablerow(l);let u="";for(let d=0;d<i.rows.length;d++){const h=i.rows[d];l="";for(let c=0;c<h.length;c++)l+=this.renderer.tablecell(this.parseInline(h[c].tokens),{header:!1,align:i.align[c]});u+=this.renderer.tablerow(l)}n+=this.renderer.table(a,u);continue}case"blockquote":{const i=r,a=this.parse(i.tokens);n+=this.renderer.blockquote(a);continue}case"list":{const i=r,a=i.ordered,l=i.start,u=i.loose;let d="";for(let h=0;h<i.items.length;h++){const c=i.items[h],p=c.checked,b=c.task;let v="";if(c.task){const S=this.renderer.checkbox(!!p);u?c.tokens.length>0&&c.tokens[0].type==="paragraph"?(c.tokens[0].text=S+" "+c.tokens[0].text,c.tokens[0].tokens&&c.tokens[0].tokens.length>0&&c.tokens[0].tokens[0].type==="text"&&(c.tokens[0].tokens[0].text=S+" "+c.tokens[0].tokens[0].text)):c.tokens.unshift({type:"text",text:S+" "}):v+=S+" "}v+=this.parse(c.tokens,u),d+=this.renderer.listitem(v,b,!!p)}n+=this.renderer.list(d,a,l);continue}case"html":{const i=r;n+=this.renderer.html(i.text,i.block);continue}case"paragraph":{const i=r;n+=this.renderer.paragraph(this.parseInline(i.tokens));continue}case"text":{let i=r,a=i.tokens?this.parseInline(i.tokens):i.text;for(;s+1<e.length&&e[s+1].type==="text";)i=e[++s],a+=`
`+(i.tokens?this.parseInline(i.tokens):i.text);n+=t?this.renderer.paragraph(a):a;continue}default:{const i='Token with "'+r.type+'" type was not found.';if(this.options.silent)return console.error(i),"";throw new Error(i)}}}return n}parseInline(e,t){t=t||this.renderer;let n="";for(let s=0;s<e.length;s++){const r=e[s];if(this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[r.type]){const i=this.options.extensions.renderers[r.type].call({parser:this},r);if(i!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(r.type)){n+=i||"";continue}}switch(r.type){case"escape":{const i=r;n+=t.text(i.text);break}case"html":{const i=r;n+=t.html(i.text);break}case"link":{const i=r;n+=t.link(i.href,i.title,this.parseInline(i.tokens,t));break}case"image":{const i=r;n+=t.image(i.href,i.title,i.text);break}case"strong":{const i=r;n+=t.strong(this.parseInline(i.tokens,t));break}case"em":{const i=r;n+=t.em(this.parseInline(i.tokens,t));break}case"codespan":{const i=r;n+=t.codespan(i.text);break}case"br":{n+=t.br();break}case"del":{const i=r;n+=t.del(this.parseInline(i.tokens,t));break}case"text":{const i=r;n+=t.text(i.text);break}default:{const i='Token with "'+r.type+'" type was not found.';if(this.options.silent)return console.error(i),"";throw new Error(i)}}}return n}}class M{constructor(e){k(this,"options");this.options=e||L}preprocess(e){return e}postprocess(e){return e}processAllTokens(e){return e}}k(M,"passThroughHooks",new Set(["preprocess","postprocess","processAllTokens"]));var _,K,Ee;class bt{constructor(...e){ce(this,_);k(this,"defaults",V());k(this,"options",this.setOptions);k(this,"parse",q(this,_,K).call(this,x.lex,$.parse));k(this,"parseInline",q(this,_,K).call(this,x.lexInline,$.parseInline));k(this,"Parser",$);k(this,"Renderer",W);k(this,"TextRenderer",se);k(this,"Lexer",x);k(this,"Tokenizer",N);k(this,"Hooks",M);this.use(...e)}walkTokens(e,t){var s,r;let n=[];for(const i of e)switch(n=n.concat(t.call(this,i)),i.type){case"table":{const a=i;for(const l of a.header)n=n.concat(this.walkTokens(l.tokens,t));for(const l of a.rows)for(const u of l)n=n.concat(this.walkTokens(u.tokens,t));break}case"list":{const a=i;n=n.concat(this.walkTokens(a.items,t));break}default:{const a=i;(r=(s=this.defaults.extensions)==null?void 0:s.childTokens)!=null&&r[a.type]?this.defaults.extensions.childTokens[a.type].forEach(l=>{const u=a[l].flat(1/0);n=n.concat(this.walkTokens(u,t))}):a.tokens&&(n=n.concat(this.walkTokens(a.tokens,t)))}}return n}use(...e){const t=this.defaults.extensions||{renderers:{},childTokens:{}};return e.forEach(n=>{const s={...n};if(s.async=this.defaults.async||s.async||!1,n.extensions&&(n.extensions.forEach(r=>{if(!r.name)throw new Error("extension name required");if("renderer"in r){const i=t.renderers[r.name];i?t.renderers[r.name]=function(...a){let l=r.renderer.apply(this,a);return l===!1&&(l=i.apply(this,a)),l}:t.renderers[r.name]=r.renderer}if("tokenizer"in r){if(!r.level||r.level!=="block"&&r.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");const i=t[r.level];i?i.unshift(r.tokenizer):t[r.level]=[r.tokenizer],r.start&&(r.level==="block"?t.startBlock?t.startBlock.push(r.start):t.startBlock=[r.start]:r.level==="inline"&&(t.startInline?t.startInline.push(r.start):t.startInline=[r.start]))}"childTokens"in r&&r.childTokens&&(t.childTokens[r.name]=r.childTokens)}),s.extensions=t),n.renderer){const r=this.defaults.renderer||new W(this.defaults);for(const i in n.renderer){if(!(i in r))throw new Error(`renderer '${i}' does not exist`);if(i==="options")continue;const a=i,l=n.renderer[a],u=r[a];r[a]=(...d)=>{let h=l.apply(r,d);return h===!1&&(h=u.apply(r,d)),h||""}}s.renderer=r}if(n.tokenizer){const r=this.defaults.tokenizer||new N(this.defaults);for(const i in n.tokenizer){if(!(i in r))throw new Error(`tokenizer '${i}' does not exist`);if(["options","rules","lexer"].includes(i))continue;const a=i,l=n.tokenizer[a],u=r[a];r[a]=(...d)=>{let h=l.apply(r,d);return h===!1&&(h=u.apply(r,d)),h}}s.tokenizer=r}if(n.hooks){const r=this.defaults.hooks||new M;for(const i in n.hooks){if(!(i in r))throw new Error(`hook '${i}' does not exist`);if(i==="options")continue;const a=i,l=n.hooks[a],u=r[a];M.passThroughHooks.has(i)?r[a]=d=>{if(this.defaults.async)return Promise.resolve(l.call(r,d)).then(c=>u.call(r,c));const h=l.call(r,d);return u.call(r,h)}:r[a]=(...d)=>{let h=l.apply(r,d);return h===!1&&(h=u.apply(r,d)),h}}s.hooks=r}if(n.walkTokens){const r=this.defaults.walkTokens,i=n.walkTokens;s.walkTokens=function(a){let l=[];return l.push(i.call(this,a)),r&&(l=l.concat(r.call(this,a))),l}}this.defaults={...this.defaults,...s}}),this}setOptions(e){return this.defaults={...this.defaults,...e},this}lexer(e,t){return x.lex(e,t??this.defaults)}parser(e,t){return $.parse(e,t??this.defaults)}}_=new WeakSet,K=function(e,t){return(n,s)=>{const r={...s},i={...this.defaults,...r};this.defaults.async===!0&&r.async===!1&&(i.silent||console.warn("marked(): The async option was set to true by an extension. The async: false option sent to parse will be ignored."),i.async=!0);const a=q(this,_,Ee).call(this,!!i.silent,!!i.async);if(typeof n>"u"||n===null)return a(new Error("marked(): input parameter is undefined or null"));if(typeof n!="string")return a(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(n)+", string expected"));if(i.hooks&&(i.hooks.options=i),i.async)return Promise.resolve(i.hooks?i.hooks.preprocess(n):n).then(l=>e(l,i)).then(l=>i.hooks?i.hooks.processAllTokens(l):l).then(l=>i.walkTokens?Promise.all(this.walkTokens(l,i.walkTokens)).then(()=>l):l).then(l=>t(l,i)).then(l=>i.hooks?i.hooks.postprocess(l):l).catch(a);try{i.hooks&&(n=i.hooks.preprocess(n));let l=e(n,i);i.hooks&&(l=i.hooks.processAllTokens(l)),i.walkTokens&&this.walkTokens(l,i.walkTokens);let u=t(l,i);return i.hooks&&(u=i.hooks.postprocess(u)),u}catch(l){return a(l)}}},Ee=function(e,t){return n=>{if(n.message+=`
Please report this to https://github.com/markedjs/marked.`,e){const s="<p>An error occurred:</p><pre>"+y(n.message+"",!0)+"</pre>";return t?Promise.resolve(s):s}if(t)return Promise.reject(n);throw n}};const E=new bt;function f(o,e){return E.parse(o,e)}f.options=f.setOptions=function(o){return E.setOptions(o),f.defaults=E.defaults,ke(f.defaults),f};f.getDefaults=V;f.defaults=L;f.use=function(...o){return E.use(...o),f.defaults=E.defaults,ke(f.defaults),f};f.walkTokens=function(o,e){return E.walkTokens(o,e)};f.parseInline=E.parseInline;f.Parser=$;f.parser=$.parse;f.Renderer=W;f.TextRenderer=se;f.Lexer=x;f.lexer=x.lex;f.Tokenizer=N;f.Hooks=M;f.parse=f;f.options;f.setOptions;f.use;f.walkTokens;f.parseInline;$.parse;x.lex;f.setOptions({breaks:!0,gfm:!0});function _e(o){const e=/^---\n([\s\S]*?)\n---\n/,t=o.match(e);if(!t)return{metadata:{},content:o};const n=t[1],s=o.slice(t[0].length),r={};return n.split(`
`).forEach(i=>{const a=i.indexOf(":");if(a>0){const l=i.slice(0,a).trim(),u=i.slice(a+1).trim().replace(/^["']|["']$/g,"");r[l]=u}}),{metadata:r,content:s}}function yt(o){return f.parse(o)}function wt(o,e=150){const{content:t}=_e(o),n=t.replace(/#{1,6}\s+/g,"").replace(/\*\*|__/g,"").replace(/\*|_/g,"").replace(/\[([^\]]+)\]\([^)]+\)/g,"$1").replace(/`([^`]+)`/g,"$1").replace(/\n+/g," ").trim();return n.length<=e?n:n.slice(0,e).trim()+"..."}function R(o){return new Date(o).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})}const m={omdb:{key:localStorage.getItem("omdb_api_key")||"",baseUrl:"https://www.omdbapi.com/"},googleBooks:{key:localStorage.getItem("google_books_api_key")||"",baseUrl:"https://www.googleapis.com/books/v1/volumes"},spotify:{clientId:localStorage.getItem("spotify_client_id")||"",clientSecret:localStorage.getItem("spotify_client_secret")||"",accessToken:null,tokenExpiry:null}};function vt(o){o.omdb&&(localStorage.setItem("omdb_api_key",o.omdb),m.omdb.key=o.omdb),o.googleBooks&&(localStorage.setItem("google_books_api_key",o.googleBooks),m.googleBooks.key=o.googleBooks),o.spotifyClientId&&(localStorage.setItem("spotify_client_id",o.spotifyClientId),m.spotify.clientId=o.spotifyClientId),o.spotifyClientSecret&&(localStorage.setItem("spotify_client_secret",o.spotifyClientSecret),m.spotify.clientSecret=o.spotifyClientSecret)}function xt(){return{omdb:m.omdb.key,googleBooks:m.googleBooks.key,spotifyClientId:m.spotify.clientId,spotifyClientSecret:m.spotify.clientSecret}}function $t(o){switch(o){case"film":return!!m.omdb.key;case"book":return!0;case"song":return!!m.spotify.clientId&&!!m.spotify.clientSecret;default:return!1}}async function It(o){if(!m.omdb.key)throw new Error("OMDb API key not configured. Please add it in the admin settings.");const e=`${m.omdb.baseUrl}?apikey=${m.omdb.key}&s=${encodeURIComponent(o)}&type=movie`,n=await(await fetch(e)).json();if(n.Error){if(n.Error==="Movie not found!")return[];throw new Error(n.Error)}return(n.Search||[]).map(s=>({id:s.imdbID,title:s.Title,year:s.Year,imageUrl:s.Poster!=="N/A"?s.Poster:null,externalUrl:`https://www.imdb.com/title/${s.imdbID}`,type:"film"}))}async function Tt(o){let e=`${m.googleBooks.baseUrl}?q=${encodeURIComponent(o)}&maxResults=10`;m.googleBooks.key&&(e+=`&key=${m.googleBooks.key}`);const n=await(await fetch(e)).json();if(n.error)throw new Error(n.error.message);return(n.items||[]).map(s=>{var i,a;const r=s.volumeInfo;return{id:s.id,title:r.title,author:r.authors?r.authors.join(", "):"Unknown",year:r.publishedDate?r.publishedDate.split("-")[0]:"",imageUrl:((a=(i=r.imageLinks)==null?void 0:i.thumbnail)==null?void 0:a.replace("http:","https:"))||null,externalUrl:r.infoLink,type:"book"}})}async function St(){if(!m.spotify.clientId||!m.spotify.clientSecret)throw new Error("Spotify API credentials not configured. Please add them in the admin settings.");if(m.spotify.accessToken&&m.spotify.tokenExpiry>Date.now())return m.spotify.accessToken;const o=btoa(`${m.spotify.clientId}:${m.spotify.clientSecret}`),t=await(await fetch("https://accounts.spotify.com/api/token",{method:"POST",headers:{Authorization:`Basic ${o}`,"Content-Type":"application/x-www-form-urlencoded"},body:"grant_type=client_credentials"})).json();if(t.error)throw new Error(t.error_description||t.error);return m.spotify.accessToken=t.access_token,m.spotify.tokenExpiry=Date.now()+t.expires_in*1e3-6e4,t.access_token}async function Et(o){var s;const e=await St(),n=await(await fetch(`https://api.spotify.com/v1/search?q=${encodeURIComponent(o)}&type=track&limit=10`,{headers:{Authorization:`Bearer ${e}`}})).json();if(n.error)throw new Error(n.error.message);return(((s=n.tracks)==null?void 0:s.items)||[]).map(r=>{var i;return{id:r.id,title:r.name,artist:r.artists.map(a=>a.name).join(", "),album:r.album.name,year:r.album.release_date?r.album.release_date.split("-")[0]:"",imageUrl:((i=r.album.images[0])==null?void 0:i.url)||null,externalUrl:r.external_urls.spotify,type:"song"}})}async function _t(o,e){if(!o.trim())return[];switch(e){case"film":return It(o);case"book":return Tt(o);case"song":return Et(o);default:throw new Error(`Unknown media type: ${e}`)}}function I(o){return{film:{label:"Film",color:"#ef4444"},book:{label:"Book",color:"#3b82f6"},song:{label:"Song",color:"#22c55e"}}[o]||{label:o,color:"#6366f1"}}const ie="zuber_seth_admin_auth",Lt="admin123";function Rt(){return localStorage.getItem(ie)==="authenticated"}function zt(o){const e=localStorage.getItem("admin_password")||Lt;return o===e?(localStorage.setItem(ie,"authenticated"),!0):!1}function At(){localStorage.removeItem(ie)}function Bt(o){localStorage.setItem("admin_password",o)}function A(){const o=localStorage.getItem("writings_data");return o?JSON.parse(o):{writings:[]}}function Le(o){localStorage.setItem("writings_data",JSON.stringify(o))}function U(){const o=localStorage.getItem("media_data");return o?JSON.parse(o):{media:[]}}function Re(o){localStorage.setItem("media_data",JSON.stringify(o))}function Ct(o,e,t){const n=A(),s=Date.now().toString(36)+Math.random().toString(36).substr(2);return n.writings.push({id:s,title:o,date:e,content:t}),Le(n),s}function Mt(o){const e=A();e.writings=e.writings.filter(t=>t.id!==o),Le(e)}function Pt(o,e,t){const n=U(),s=Date.now().toString(36)+Math.random().toString(36).substr(2);return n.media.push({id:s,type:o.type,title:o.title,artist:o.artist||o.author||"",year:o.year||"",imageUrl:o.imageUrl,externalUrl:o.externalUrl,rating:e,review:t,date:new Date().toISOString().split("T")[0]}),Re(n),s}function Dt(o){const e=U();e.media=e.media.filter(t=>t.id!==o),Re(e)}function ze(o){o.innerHTML=`
        <div class="container">
    ...
    `;const e=document.getElementById("login-form"),t=document.getElementById("login-error");e.addEventListener("submit",n=>{n.preventDefault();const s=document.getElementById("password-input").value;zt(s)?Ae(o):(t.textContent="Incorrect password",t.style.display="block")})}function Ae(o){o.innerHTML=`
    ...
    `;let e=null,t=0;const n=document.getElementById("media-search"),s=document.getElementById("search-btn"),r=document.getElementById("media-type"),i=document.getElementById("search-results"),a=document.getElementById("review-form");r.addEventListener("change",()=>{const c=r.value;$t(c)||w(`${I(c).label} search requires API configuration. Check Settings.`,"error")});async function l(){const c=n.value.trim(),p=r.value;if(c){i.innerHTML='<div class="loading"><div class="spinner"></div></div>',a.style.display="none",e=null;try{const b=await _t(c,p);u(b)}catch(b){i.innerHTML=`<p style="color: var(--color-error);">${b.message}</p>`}}}s.addEventListener("click",l),n.addEventListener("keypress",c=>{c.key==="Enter"&&l()});function u(c){if(c.length===0){i.innerHTML='<p style="color: var(--color-text-muted);">No results found</p>';return}i.innerHTML=c.map(p=>`
            <div class="search-result-item" data-id="${p.id}">
                <div class="search-result-image">
                    ${p.imageUrl?`<img src="${p.imageUrl}" alt="${p.title}">`:`<div style="display:flex;align-items:center;justify-content:center;height:100%;font-size:1rem;color:var(--color-text-muted);">${I(p.type).label}</div>`}
                </div>
                ...
                ${e.length===0?'<p style="color: var(--color-text-muted);">No writings yet</p>':e.map(n=>`
                        <div class="content-item">
                            <div class="content-item-info">
                                ...
                                <div class="content-item-meta">${R(n.date)}</div>
                            </div>
                        ...
                        <div class="content-item">
                            ...
                            <div class="content-item-info">
                                ...
                                <div class="content-item-meta">
                                    ${I(n.type).label} • ${"★".repeat(n.rating)}${"☆".repeat(5-n.rating)} • ${R(n.date)}
                                </div>
                            </div>
                            <div class="content-item-actions">
    ...
    `,o.querySelectorAll("[data-delete-writing]").forEach(n=>{n.addEventListener("click",()=>{confirm("Are you sure you want to delete this writing?")&&(Mt(n.dataset.deleteWriting),w("Writing deleted","success"),J(o))})}),o.querySelectorAll("[data-delete-media]").forEach(n=>{n.addEventListener("click",()=>{confirm("Are you sure you want to delete this review?")&&(Dt(n.dataset.deleteMedia),w("Review deleted","success"),J(o))})})}function Ot(o){const e=xt();o.innerHTML=`
        <div class="card" style="margin-bottom: var(--space-6);">
    ...
    `,document.getElementById("change-password").addEventListener("click",()=>{const t=document.getElementById("new-password").value;if(t.length<4){w("Password must be at least 4 characters","error");return}Bt(t),w("Password changed successfully","success"),document.getElementById("new-password").value=""}),document.getElementById("save-api-keys").addEventListener("click",()=>{vt({omdb:document.getElementById("omdb-key").value.trim(),googleBooks:document.getElementById("google-books-key").value.trim(),spotifyClientId:document.getElementById("spotify-client-id").value.trim(),spotifyClientSecret:document.getElementById("spotify-client-secret").value.trim()}),w("API keys saved successfully","success")})}function w(o,e="success"){let t=document.querySelector(".toast-container");t||(t=document.createElement("div"),t.className="toast-container",document.body.appendChild(t));const n=document.createElement("div");n.className=`toast toast-${e}`,n.textContent=o,t.appendChild(n),setTimeout(()=>{n.remove()},3e3)}const z=new De,T=document.getElementById("main-content");function Be(o){return Array(5).fill(0).map((e,t)=>`<span class="star ${t<o?"filled":""}">★</span>`).join("")}z.on("/",()=>{const o=A().writings,e=U().media,t=[...o].sort((s,r)=>new Date(r.date)-new Date(s.date)).slice(0,8),n=[...e].sort((s,r)=>new Date(r.date)-new Date(s.date)).slice(0,8);T.innerHTML=`
                            ...
                            ${t.map(s=>`
                                <a href="#/writing/${s.id}" class="shelf-item shelf-item-writing">
                                    ...
                                    <div class="shelf-item-content">
                                        <span class="shelf-item-date">${R(s.date)}</span>
    ...
    `});z.on("/writing",()=>{const o=A().writings;if(o.length===0){T.innerHTML=`
            <div class="container">
        ...
        `;return}const e=[...o].sort((t,n)=>new Date(n.date)-new Date(t.date));T.innerHTML=`
        <div class="container">
            <div class="section-header fade-in">
                <h1 class="section-title">Writing</h1>
            </div>
            <div class="writings-grid fade-in">
                ${e.map(t=>`
                    <a href="#/writing/${t.id}" class="card card-clickable writing-card">
                        <span class="writing-card-date">${R(t.date)}</span>
                        <h2 class="writing-card-title">${t.title}</h2>
                        <p class="writing-card-excerpt">${wt(t.content)}</p>
                    </a>
                `).join("")}
            </div>
        </div>
    `});z.on("/writing/:id",o=>{const t=A().writings.find(i=>i.id===o.id);if(!t){z.show404();return}const{metadata:n,content:s}=_e(t.content),r=yt(s);T.innerHTML=`
        <div class="container article-container fade-in">
            <div class="article-header">
                ...
                <p class="article-date">${R(t.date)}</p>
            </div>
            <div class="article-content">
                ${r}
            </div>
        </div>
    `});z.on("/media",()=>{const o=U().media;if(o.length===0){T.innerHTML=`
            <div class="container">
                <div class="section-header fade-in">
        ...
        `;return}const e=[...o].sort((n,s)=>new Date(s.date)-new Date(n.date)),t=[...new Set(e.map(n=>n.type))];T.innerHTML=`
        <div class="container">
            <div class="section-header fade-in">
                <h1 class="section-title">Media</h1>
            </div>
    ...
    `,document.querySelectorAll(".filter-btn").forEach(n=>{n.addEventListener("click",()=>{document.querySelectorAll(".filter-btn").forEach(i=>i.classList.remove("active")),n.classList.add("active");const s=n.dataset.filter,r=s==="all"?e:e.filter(i=>i.type===s);document.getElementById("media-grid").innerHTML=me(r)})})});function me(o){return o.map(e=>`
        <div class="card media-card">
            ...
            <div class="media-card-content">
                ...
                <span class="media-card-date">${R(e.date)}</span>
            </div>
        </div>
    `).join("")}z.on("/admin",()=>{Rt()?Ae(T):ze(T)});console.log("Zuber Seth Personal Website initialized");
